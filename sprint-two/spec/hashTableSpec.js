describe('hashTable', function() {
  var hashTable;
  var people = [['Steven', 'Tyler'], ['George', 'Harrison'], ['Mr.', 'Doob'], ['Dr.', 'Sunshine'], ['John', 'Resig'], ['Brendan', 'Eich'], ['Alan', 'Turing'], ['a', 'b'], ['c', 'd']];
  ...
  it('should increment the counter when a new bucket is initialized', function() {
    hashTable.insert('Steven', 'Tyler');
    hashTable.insert('John', 'Lennon');
    hashTable.insert('Fred', 'Zirdung');
    hashTable.insert('a', 'b');
    expect(hashTable.counter).to.equal(3);
  });
